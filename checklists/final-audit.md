...
- [ ] evidence hierarchy is visible: 确认事实, well-supported inferences, and weak claims are not mixed
...
- [ ] for asset injection, financing, restructuring, M&A, or similar corporate actions, the report separates 确认的交易事实 from likely implications and from 未知
