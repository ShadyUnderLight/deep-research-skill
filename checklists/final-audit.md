...
- [ ] for academic / literature review tasks, search strategy is documented (databases, search terms with Boolean operators, inclusion/exclusion criteria, screening counts, search date) — required when the report claims "系统化综述" or "有限范围系统化综述"; see `references/academic-evidence-hierarchy.md` §措辞纪律 for wording discipline — methodology transparency must match the claimed review type
