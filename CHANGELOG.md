...
- `tests/fixtures/audit/` (#378): end-to-end positive/negative fixtures for market-outlook, shared-workflow and a mixed route (market-outlook + constrained-choice secondary) plus a valid research pack; `tests/test_audit_fixtures.py` proves required audits trigger under `--strict --require-contract` (positive exit 0, negative exit 2 with the expected audit id).
