...
- `.github/workflows/ci.yml`: added validator regression tests with properly isolated single-mutation samples covering code-block heading, empty section, H3 instead of H2, blockquote heading, indented fence, sub-heading-only body, and partial heading match.
