...
| `evals/cases/ai-startup-hq-constrained-choice-register-compliance-case.md` | constrained-choice | Triggered | Triggered | N/A | N/A | N/A | Triggered | Triggered | Triggered | Candidate case: register compliance against 7-column template. |
...
| `evals/cases/byd-competitive-positioning-traceability-hard-fail-case.md` | competitive-positioning | Triggered | Failed execution | N/A | N/A | N/A | Triggered | Triggered | Triggered | Candidate: traceability hard-fail with secondary-source label inflation. |
...
| `evals/cases/content-platform-constrained-choice-compounded-fail-case.md` | constrained-choice | N/A | Triggered | N/A | Failed execution | N/A | Triggered | Triggered | Triggered | Candidate: hard-fail benchmark for constrained-choice tables without numeric role columns. |
...
| `evals/cases/deepseek-competitive-positioning-evidence-label-case.md` | competitive-positioning | Triggered | Failed execution | N/A | N/A | N/A | Triggered | Triggered | Triggered | Candidate: guards secondary-source label escalation in competitive positioning reports. |
...
| `evals/cases/eu-dma-regulatory-scenario-probability-and-action-tiering-case.md` | regulatory-analysis | Triggered | N/A | Failed execution | N/A | N/A | Triggered | Triggered | Triggered | Candidate: scenario probabilities without method/source basis. |
...
| `evals/cases/indie-dev-constrained-choice-delivery-fail-case.md` | constrained-choice | N/A | Triggered | N/A | Triggered | N/A | Triggered | Failed execution | Triggered | Candidate: delivery-cleanliness and quantitative-role gaps in constrained-choice. |
